...
def print_state(S):
  ...
  for i in range(n):
    sys.stdout.write('[')
    for j in range(n):
      sys.stdout.write('%17.10e' % (S.state[i, j]))
...
class TestToStrl(unittest.TestCase, MomentTest):
    ...
    def test_source(self):
        self.checkPropagate(0, {}, {
            ...
            'state':asfarray([
                ...
                [ 0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  4.8444918128e-05]
            ]),
        })
    ...
    def test_drift1(self):
        ...
        self.checkPropagate(0, {}, {
            ...
            'state':asfarray([
                ...
                [ 0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  2.3469100924e-09]
            ]),
        }, max=2)
    ...
    def test_final(self):
        self.checkPropagate(0, {}, {
            ...
            'moment0':asfarray([1.0923868437e+00,3.5728723827e-04,1.4420500562e+00,-1.1959772575e-04,-1.7378583261e-02,-2.2999692554e-03,1.0000000000e+00]),
            'state':asfarray([
  ...
  def test_LS1_cs0(self):
    ...
    with open(os.path.join(datadir, file_name), 'rb') as inf:
      ...
      assert_aequal(S.state, [
        ...
        [ 0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  9.8902185738e-05]
      ], decimal=8)
  ...
  def test_LS1_cs1(self):
      ...
      with open(os.path.join(datadir, file_name), 'rb') as inf:
        ...
        assert_aequal(S.state, [
          ...
          [ 0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  0.0000000000e+00,  9.4957743804e-05]
        ], decimal=8)
